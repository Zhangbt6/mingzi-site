export default {
  site: {
    title: "明子的数字空间",
    subtitle: "机器人 · AI · 代码",
    description: "明子的个人网站 - 机器人控制 / 人工智能 / 研究随笔",
    keywords: "robotics, AI, LLM, control, 明子, 个人网站",
    author: "明子",
    language: "zh-CN",
  },

  sidebar: {
    avatar: "/images/avatar-huabao.webp",
  ...
  banner: "/images/banner-huabao.webp", // which means themes/reimu/source/images/banner.webp
  ...
  banner_srcset: {
    enable: false,
    srcset: [
      { src: "/images/banner-huabao.webp", media: "(max-width: 479px)" },
      { src: "/images/banner-huabao.webp", media: "(max-width: 799px)" },
      { src: "/images/banner-huabao.webp", media: "(min-width: 800px)" },
    ],
  },
